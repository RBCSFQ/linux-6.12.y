...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 12, 0) && LINUX_VERSION_CODE < KERNEL_VERSION(6, 0, 0)
...
static struct genl_family sprdwl_nl_genl_family = {
	...
	/* .pre_doit = sprdwl_npi_pre_doit,  -- removed for 6.12 genl_family API change */
	/* .post_doit = sprdwl_npi_post_doit,  -- removed for 6.12 genl_family API change */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 14, 0)
	.module = THIS_MODULE,
